...
namespace Lang {
	...
	sortText = {"None", "No.", "Species", "Form", "Type 1", "Type 2", "HP", "Attack", "Defense", "Sp. Atk", "Sp. Def", "Speed", "HP IV", "Attack IV", "Defense IV", "Sp. Atk IV", "Sp. Def IV", "Speed IV", "Nature", "Level", "TID", "Hidden Power type", "Friendship", "Name", "Orig. Trainer", "Shiny"},
